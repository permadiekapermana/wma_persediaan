...
<head>
    ...
    <title>Login Page: Auto2000 Cirebon</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="../index.html"><img class="logo-img" src="../assets/images/auto_2000.png" width="70%" alt="logo"></a><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
                <form action="cek_login.php" method="post">
                  ...
                  &copy; 2019 - Auto2000 Cirebon <br> <a href="#">Irfan Saputra</a>
                </div>
                </form>
            </div>
